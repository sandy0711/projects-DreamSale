...
{
    /// <summary>
    /// Represents a DreamSaleConfig
    /// </summary>
    public partial class DreamSaleConfig : IConfigurationSectionHandler
    {
        #region Properties
        /// <summary>
        ...
        /// <summary>
        /// Indicates whether we should support previous DreamSaleCommerce versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousDreamSalecommerceVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during DreamSaleCommerce installation
        /// </summary>
        ...
        {
            var config = new DreamSaleConfig();
            ...
            var supportPreviousDreamSalecommerceVersionsNode = section.SelectSingleNode("SupportPreviousDreamSalecommerceVersions");
            config.SupportPreviousDreamSalecommerceVersions = GetBool(supportPreviousDreamSalecommerceVersionsNode, "Enabled");
